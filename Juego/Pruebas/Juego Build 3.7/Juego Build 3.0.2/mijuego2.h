...
void carga_escenario()
{
    ...
    case 1:// casa
              ...
              alto  = (BITMAP *)datos_del_juego[dicasasup].dat;
    ...
    case 2:// bosque
              ...
              choque = (BITMAP *)datos_del_juego[dibosquechoque2].dat;
              alto  = (BITMAP *)datos_del_juego[dibosquesup].dat;
    ...
    case 3:// ciudad
              ...
              alto  = (BITMAP *)datos_del_juego[diciudad1sup].dat;
    ...
    case 4:// tienda1
          ...
          alto  = (BITMAP *)datos_del_juego[ditienda1sup].dat;
...
void evento_escenario()
{
    ...
    case 3:   // ciudad
     ...
     if ( personajes[10].getestado() == 6 && cambio == 0 && !personajes[8].posicion_cerca())
     {
          personajes[10].cambia_estado(0);
     }
     if ( personajes[11].getestado() == 6 && cambio == 0 && !personajes[9].posicion_cerca())
     {
     ...
     if ( personajes[10].posicion_cerca(9) &&  personajes[8].alineado_vertical()
     ...
     if ( personajes[11].posicion_cerca(9) &&  personajes[9].alineado_vertical()
...
void carga_juego()
{
    ...
    if ( !datobjeto ){
       allegro_message("Error: archivo datobjeto.dat no encontrado\n%s\n", allegro_error);
    }
...
swtienda=0;
    //Parte de numero los primeros 2 indican en donde van a aparecer luegos los siguientes 2 indican que accion y el ultimo en que lugar va a estar
personajes[0].crea( (BITMAP *)datos_del_juego[diper001].dat, 1300,700, 1,1,3);
personajes[1].crea( (BITMAP *)datos_del_juego[diper005].dat, 280, 450, 0,2,3);
personajes[2].crea( (BITMAP *)datos_del_juego[diper005].dat, 230, 280, 3,2,3);
personajes[3].crea( (BITMAP *)datos_del_juego[diper003].dat, 960, 310, 2,3,3);
personajes[4].crea( (BITMAP *)datos_del_juego[diper005].dat, 1120, 450, 0,4,3);
personajes[5].crea( (BITMAP *)datos_del_juego[diper004].dat, 900, 650, 1,5,3);
personajes[6].crea( (BITMAP *)datos_del_juego[diper006].dat, 850, 800, 0,0,3);
personajes[7].crea( (BITMAP *)datos_del_juego[diper001].dat, 530, 280, 1,5,3);
personajes[8].crea( (BITMAP *)datos_del_juego[diper004].dat, 160,120, 2,4,1);
personajes[9].crea( (BITMAP *)datos_del_juego[diper002].dat, 50, 200, 3,5,1);
personajes[10].crea( (BITMAP *)datos_del_juego[diper007].dat, 334, 170, 0,0,4);
personajes[11].crea( (BITMAP *)datos_del_juego[diper008].dat, 142, 170, 0,0,4);
nmalos = 3;
malos[0].crea( (BITMAP *)datos_del_juego[diene001].dat, 380, 280, 0,5,2,100);
malos[1].crea( (BITMAP *)datos_del_juego[diene001].dat, 375, 300, 0,5,2,100);
malos[2].crea( (BITMAP *)datos_del_juego[diene001].dat, 250, 250, 0,5,2,100);
texto.crea("Presiona las teclas de direccion para moverte, y enter para platicar con los NPCS",
   font, 5,5,230,60 );
...
void pinta_juego()
{
    ...
    blit( fondo, buffer, ax, ay, bx, by, ancho, alt);
    blit( fondo, buffer, ax, ay, bx, by, ancho, alt);
    jugador.pinta();

    masked_blit( alto, buffer, ax, ay, bx, by, ancho, alt);
    texto.pinta(buffer);
